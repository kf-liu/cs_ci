...
<body>
    <div id="container">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">用户页面>>
            <a class="navbar-brand" href="<?php echo site_url() ?>">长沙 · 首页</a>
            ...
            <div class="collapse navbar-collapse" id="navbarColor02">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="#">长沙简介 <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">风土人情</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">吃在长沙</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">路线选择</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">自助行</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">摄影摄像</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">游记精选</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">我的论坛</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">湘江风光</a>
                    </li>
                </ul>
