...
<div id="globallink">
    <ul>
        ...
        <li><a href="<?php echo site_url('home/intro') ?>">长沙简介</a></li>
        <li><a href="<?php //echo site_url('home/people') ?>">风土人情</a></li>
        <li><a href="<?php echo site_url('home/food') ?>">吃在长沙</a></li>
        <li><a href="<?php //echo site_url('home/line') ?>">路线选择</a></li>
        <li><a href="<?php echo site_url('home/go') ?>">自助行</a></li>
        ...
        <li><a href="<?php echo site_url('home/xiang') ?>">湘江风光</a></li>
    </ul>
</div>
<div>