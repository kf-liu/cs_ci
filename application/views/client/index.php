...
<div id="below">
    <div id="left">
        <div id="weather">
            ...
            <ul>
                <li>长沙&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;北风一级 软风&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;晴 20℃-31℃</li>
                <li>株洲&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;北风一级 软风&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;晴 20℃-28℃</li>
                <li>湘潭&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;北风一级 软风&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;晴 20℃-32℃</li>
                <li>浏阳&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;北风一级 软风&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;晴 20℃-28℃</li>
                <li>望城&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;北风一级 软风&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;晴 20℃-30℃</li>
            </ul>
            <br>
        </div>
        <div id="today">
    ...
    <div id="middle">
        ...
        <div id="route">
            ...
            <ul>
                ...
                <li><a href="#">芙蓉广场——定王大厦——五一广场——IFS——国金中心</a></li>
                <li><a href="#">南门口——坡子街——步行街——太平街——沿江风光带</a></li>
                <li><a href="#">五一广场——橘子洲——岳麓山——湖南大学——湖南师范大学——中南大学</a></li>
                <li><a href="#">橘子洲——梅溪湖——柏乐园——洋湖湿地公园——南郊公园</a></li>
            </ul>
            <br>
        </div>
    </div>
    <div id="right">
        ...
        <div id="life">
            <h3><span>周边景点</span></h3>
            <ul>
                <li><a href="#">五一广场</a></li>
                <li><a href="#">湖南省植物园</a></li>
                <li><a href="#">橘子洲</a></li>
                <li><a href="#">岳麓山</a></li>
                <li><a href="#">长沙市规划馆</a></li>
                <li><a href="#">太平老街</a></li>
                <li><a href="#">世界之窗</a></li>
                <li><a href="#">湖南省博物馆</a></li>
                <li><a href="#">靖港古镇</a></li>
            </ul>
            <br>
        </div>
